# -*- coding: utf-8 -*-
"""WordCloud Demo.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Q6htUFOcq6ZfqLF8r8aOvzlMJiq_Pdnh
"""
...
try:
  # Attempt to open the image file directly with Pillow
  mask = np.array(PIL.Image.open('/content/Python-logo-notext.svg'))
except PIL.UnidentifiedImageError:
  # If Pillow fails, attempt to convert SVG to PNG using cairosvg
  print("Pillow couldn't open the SVG file. Trying cairosvg...")
  svg_data = open('/content/Python-logo-notext.svg', 'rb').read()
  png_data = cairosvg.svg2png(bytestring=svg_data)
  mask = np.array(PIL.Image.open(io.BytesIO(png_data)))
